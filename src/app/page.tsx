...
export default function Home() {
  ...
  return <>
    ...
    <main>
      <section className="shell hero"><div><div className="eyebrow">Seu momento de cuidado</div><h1>Beleza nos detalhes, cuidado em cada momento.</h1><p className="lead">Escolha seu serviço, encontre o melhor horário e faça seu agendamento online de forma simples.</p><div className="flow" aria-label="Etapas do agendamento"><div className="step"><span>1</span><div><strong>Serviço</strong><small>Escolha seu cuidado</small></div></div><div className="step"><span>2</span><div><strong>Data</strong><small>Selecione o melhor dia</small></div></div><div className="step"><span>3</span><div><strong>Horário</strong><small>Veja os horários livres</small></div></div><div className="step"><span>4</span><div><strong>Seus dados</strong><small>Confirme a reserva</small></div></div></div><Link className="btn btn-primary" href="/agendar"><Sparkles size={17}/> Quero agendar</Link></div><div className="hero-card"><Heart size={34}/><strong>Um espaço feito para você.</strong><p className="section-copy">Organize seu horário sem mensagens de ida e volta e veja as opções realmente disponíveis.</p></div></section>
